...
import Imagem4 from '../media/img/palco-omni.png';
import Imagem5 from '../media/img/palco-ultra.png';
...
const stages = [
  ...
  { id: 4, imagem: Imagem4, titulo: "Palco Omni", subtitulo:"Painéis épicos? Temos! Não são apenas os universos dos seus filmes, séries, HQs, podcasts e livros favoritos que estão na CCXP, os criadores deles também estão aqui. E, melhor ainda, você pode ter a chance de aprender ao vivo com uma galera que manja um pouquinho de como contar histórias. (Alerta de sarcasmo)No Palco Ultra, você acompanha debates, masterclasses, palestras e workshops com monstros sagrados da cultura pop como Frank Miller e Mauricio de Sousa, que já foram nossos convidados em edições anteriores. Além disso, tem também campanhas de RPG ao vivo, lançamento de trailers e pré-estreias exclusivas."},
  { id: 5, imagem: Imagem5, titulo: "Palco Ultra", subtitulo:"A programação da CCXP ganha ainda mais fôlego com o novo Palco Omni. É um espaço mais intimista, com 250 lugares, que receberá painéis e bate-papos sobre quadrinhos, colecionáveis e produções audiovisuais, além de uma agenda ampliada de masterclasses e muitos outros conteúdos pensados para diferentes comunidades de fãs.Inspirado na palavra latina 'omni', que significa 'tudo' ou 'todos', o Palco Omni é uma homenagem à universalidade e à diversidade das nossas paixões e será seu novo lugar favorito da CCXP.."},
];
